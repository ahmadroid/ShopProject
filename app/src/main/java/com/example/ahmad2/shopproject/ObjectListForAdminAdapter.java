...
public class ObjectListForAdminAdapter extends RecyclerView.Adapter<ObjectListForAdminAdapter.FavViewHolder> {
    ...
    public ObjectListForAdminAdapter(Context context, Activity activity, List<ObjectInfo> objectList, OnItemClickListener listener) {
    ...
    public FavViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_for_object_list_for_admin, parent, false);
    ...
    public class FavViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView txtName, txtPrice, txtDes, txtSeen;
        private ImageView objImg;
        private App app;
        private LruCache<Long, Bitmap> imageCache;
        private int maxMemory;
        private ObjectInfo objectInfo;
        private FloatingActionButton fltDel;

        public FavViewHolder(@NonNull View itemView) {
            super(itemView);
            objImg = itemView.findViewById(R.id.img_item_object_list_for_admin);
            txtName = itemView.findViewById(R.id.txt_name_item_object_list_for_admin);
            txtName.setMovementMethod(new ScrollingMovementMethod());
            txtPrice = itemView.findViewById(R.id.txt_price_item_object_list_for_admin);
            txtDes = itemView.findViewById(R.id.txt_description_item_object_list_for_admin);
            fltDel = itemView.findViewById(R.id.flt_btn_item_object_list_for_admin);
            txtSeen = itemView.findViewById(R.id.txt_seen_item_object_list_for_admin);
...
//            if (objectInfo.getIsSell()==1) {
            fltDel.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    listener.onItemClick(objectInfo);
                }
            });
//            imageCache = new LruCache<>(maxMemory / 10);
            app = new App(context);
            ...
            if (objectInfo.getIsAgree() == 1) {
                txtSeen.setText(context.getResources().getString(R.string.confirm));
                txtSeen.setTextColor(Color.GREEN);
            } else if (objectInfo.getIsAgree() == 0) {
                txtSeen.setText(context.getResources().getString(R.string.not_confirm));
