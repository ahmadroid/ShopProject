...
public class FragmentSellSpecialForUserAgree extends Fragment {

    private SellSpecialAdapterAgree adapter;
...
//        preferences = getContext().getSharedPreferences("userInfoPre", Context.MODE_PRIVATE);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.layout_fragment_sell_special_agree, container, false);
        recyclerView = view.findViewById(R.id.recycler_sell_special_agree);
        progBar = view.findViewById(R.id.prog_sell_special_agree);
        relLayout=view.findViewById(R.id.rel_layout_sell_special_agree);
        txtEmpty=view.findViewById(R.id.txt_empty_sell_special_agree);
        srchView = view.findViewById(R.id.srch_view_sell_special_agree);
...
//        progBar.setVisibility(View.VISIBLE);
        ...
        login.user=user;
        login.pass="";
        Call<ResponseShopListToken> call = retrofitService.getSellSpecialAgree(login);
    ...
    public void showList() {
        adapter = new SellSpecialAdapterAgree(getContext(), shopList, new SellSpecialAdapterAgree.OnItemClickListener() {
            @Override
            ...
            @Override
            public void onFloatDeleteClick(Shop shop) {
                progBarVisible();
                OkHttpClient.Builder clientBuilder=new OkHttpClient.Builder();
                clientBuilder.addInterceptor(new Interceptor() {
                    @Override
                ...
                Call<ResponseMessageToken> call = retrofitService.deleteSellSpecial(requestLoginShop);
